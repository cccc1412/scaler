...
class ModelStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/serverless.model.Model/Predict',
...
def add_ModelServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'serverless.model.Model', rpc_method_handlers)
...
class Model(object):
    ...
    def Predict(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/serverless.model.Model/Predict',
